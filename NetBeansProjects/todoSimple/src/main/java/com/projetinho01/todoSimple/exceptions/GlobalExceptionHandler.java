...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<Object> handleDataBindViolationExceptionException(
        DatabindException databindException,
        WebRequest request){
            log.error("Failed to save entity with associated data", databindException);
            return buildErrorResponse(databindException, HttpStatus.CONFLICT, request);
    }
