...
public class PacienteDAO {
    ...
    public void cadastrarPaciente(Paciente pac) throws SQLException {
        ...
        try {
            ...
            if(pac.getNome() != null && pac.getEndereco() != null && pac.getCpf() != null && pac.getTelefone()!= null && pac.getDataNascimento()!= null){
            if((pac.getCpf().length() == 14 && pac.getCpf().matches("^[0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}")) && pac.getNome().length() <= 55 && pac.getTelefone().matches("^\\([0-9]{2}\\)[0-9]{4}-[0-9]{4}$")){
            ...
            JOptionPane.showMessageDialog(null, "Paciente cadastrado com sucesso!");
                ...
                JOptionPane.showMessageDialog(null, "Os dados de cadastro devem se Atentar as seguintes Limitacoes: \n"
                        + "CPF Deve seguir o Formato 'xxx.xxx.xxx-xx'\n" + "Nome deve conter no Maximo 55 caracteres\n" + "Telefone deve ser escrito no formato '(xx)xxxx-xxxx'\n"
                        + "Data de Nascimento deve ser escrita no Formato 'dd/mm/yyyy'\n" + "Campo endereco deve Conter menos de 200 caracteres");
            }}else{
                JOptionPane.showMessageDialog(null, "Os Campos Nome, Data de Nascimento, Telefone, Endereco e CPF devem ser preenchidos Obrigatoriamente");
            }
