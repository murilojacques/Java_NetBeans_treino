 ...
 * @author Murilo
 */
public class Tela_exclusao1 extends javax.swing.JFrame {

    /**
     * Creates new form Tela_exclusao
     */
    public Tela_exclusao1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_exclusao1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_exclusao1().setVisible(true);
            }
        });
    }
