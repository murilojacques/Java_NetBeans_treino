 ...
 * @author Murilo
 */
public class Tela_Atualizar1 extends javax.swing.JFrame {

    /**
     * Creates new form Tela_Atualizar
     */
    public Tela_Atualizar1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Atualizar1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Atualizar1().setVisible(true);
            }
        });
    }
