...
public class Tela_Listagem extends javax.swing.JFrame {
    public void preencherTabela(List<informacoes> info){
        String[] colunas ={"id", "Nome", "Idade", "Genero", "Nacionalidade"};
        String[][] dados= new String[info.size()][colunas.length];
        
        int j=0;
        for(informacoes i: info){
            dados[j]= new String[]{
            String.valueOf(i.getId()),
            i.getNome(),
            String.valueOf(i.getIdade()),
            i.getGenero(),
            i.getNacionalidade()
            };
            j++;
    ...
    public Tela_Listagem() {
        initComponents();
        informacoesDao infoDao = new informacoesDao();
        List<informacoes> listagem = infoDao.listar();
        preencherTabela(listagem);
    }
